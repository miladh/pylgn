...
.. note::
    If GIF file do not have a "duration" key (time between frames in an animation) 30 ms is used by default. See `Pillow documentation <http://pillow.readthedocs.io/en/3.1.x/handbook/image-file-formats.html>`_ for details.
